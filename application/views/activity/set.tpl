<form action="operation/activity/set" method='post' id="pagerForm" data-toggle="validate">
        ...
        <div id="one-step">
            <table class="table">
                ...
                <tr>
                    <td>是否上架：</td>
                    <td>
                        <label for="online">上架</label><input type="radio" data-toggle="icheck" name="status" checked value="1" id="online"/>
                        <label for="offline">下架</label><input type="radio" data-toggle="icheck" name="status" value="2" id="offline"/>
                    </td>
                </tr>
                <tr>
                    <td>活动时间：</td>
                    <td>
                        <input type="text" value="" data-pattern="yyyy-MM-dd HH:mm:ss" size="18" id="start_time" name="start_time" class="form-control" placeholder="开始时间" data-toggle="datepicker">&nbsp;~
                        <input type="text" value="" data-pattern="yyyy-MM-dd HH:mm:ss" size="18" id="end_time" name="end_time" class="form-control" placeholder="结束时间" data-toggle="datepicker">
                    </td>
                </tr>
                <tr>
                    <td>封面图片：</td>
